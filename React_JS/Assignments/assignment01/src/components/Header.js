                    ...
                    >
                        ...
                        <Offcanvas.Body className="m-0 p-0">
                            <Nav className="justify-content-end flex-grow-1">
                                <Link className='menu-item' to='/products'>CHANTELLE</Link>
                                <Link className='menu-item' to='/products'>READY TO WEAR</Link>
                                <Link className='menu-item' to='/products'>DUPATTAS</Link>
                                <Link className='menu-item' to='/products'>SHAWLS</Link>
                                <Link className='menu-item' to='/products'>UNSTITCHED</Link>
                                <Link className='menu-item' to='/products'>BOTTOMS</Link>
                            </Nav>
