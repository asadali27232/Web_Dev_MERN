    ...
    return (
        <>
            <Navbar key={false} bg="light" expand={false}>
                <Container fluid>
                    <div className='flex justify-between justify-items-center w-100'>
                        ...
                        <Navbar.Brand className="icons flex justify-center justify-items-center">
                            ...
                            <Link to='/Wishlist' className='mx-2'>
                                <svg class="icon icon-wishlist" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="#666666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
                                </svg>
                            </Link>
                            ...
                            <Link to='/cart' className='mx-2'>
                                <svg class="icon icon-cart-empty icon-cart" width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
